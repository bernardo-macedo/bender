...
bool Collision::RectsCollided(GameObject* a_, GameObject* b_){
    // Calculate the sides of rect A.
    /*const int leftA = a_->GetBox().GetX();
...
//Collision::RectangleSide Collision::RectsCollidedSide(const GameObject* a_, const GameObject* b_){
